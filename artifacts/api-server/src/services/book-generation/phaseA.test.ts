...
test("Phase A story plan creates a canonical 12-page story before image generation", () => {
  ...
  assert.match(storyPlan.masterSheetPrompt, /Scene 1, row 1, column 1/);
  assert.match(storyPlan.masterSheetPrompt, /artwork only/i);
  assert.doesNotMatch(storyPlan.masterSheetPrompt, /close-up/i);
